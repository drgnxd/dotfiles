...
- To add or bump a local plugin, pin its package dependency and lockfile entry, then add its configuration to `opencode.local.json` and rebuild the home-manager activation package.
