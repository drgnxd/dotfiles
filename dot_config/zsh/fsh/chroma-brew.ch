...
chroma/brew() {
    ...
    case "$__wrd" in
        # Subcommands
        analytics|autoremove|bundle|casks|cleanup|commands|config|deps|desc|doctor|fetch|gist-logs|help|home|info|install|leaves|link|list|log|missing|migrate|options|outdated|pin|postinstall|readall|reinstall|search|shellenv|style|switch|tap|tap-info|tap-pin|tap-unpin|uninstall|unlink|unpin|update|update-report|update-reset|upgrade|uses|vendor-install)
